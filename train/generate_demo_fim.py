...
question = DEFAULT_IMAGE_TOKEN + " What activity is the person (or people) performing in this image?"

explanation_max_token = 15 
answer_max_token = 4
...
cont = model.generate(
    ...
    steps=64, gen_length=64, block_length=64, tokenizer=tokenizer, stopping_criteria=['<|eot_id|>'], 
